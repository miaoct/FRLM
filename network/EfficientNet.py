...
class EfficientNetAuto(EfficientNet):
    def init_att(self):
        """
...
class EfficientNetGenAuto(FeatureExtractor):
    def __init__(self, dropout_rate=0):
        super(EfficientNetGenAuto, self).__init__()
...
class EfficientNetAutoB7(EfficientNetGenAuto):
    def __init__(self, dropout_rate=0):
        super(EfficientNetAutoB7, self).__init__()